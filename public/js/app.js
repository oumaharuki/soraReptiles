...
if ($('.ibanner').length) {
    var swiper = new Swiper('.swiper-container', {
        ...
        onInit: function(swiper) {
            swiper.slides[2].className = "swiper-slide swiper-slide-active"; //绗竴娆℃墦寮€涓嶈鍔ㄧ敾
        },
        breakpoints: {
            668: {
                slidesPerView: 1,
...
if($(".v_con_box .play_num_list")){
    $(".v_con_box .play_num_list").eq(0).show()
}
